...
@Component({
    selector: 'my-current-research',
    templateUrl: 'my-current-research.component.html',
    styleUrls: ['my-current-research.component.scss']
})
export class MyCurrentResearchComponent{
